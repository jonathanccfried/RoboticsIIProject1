...
figure(1)
plot(qdlist(1,:),qdlist(2,:),qlist(1,:),qlist(2,:),qhatKFlist(1,:),qhatKFlist(2,:))
grid on
xlabel('x')
ylabel('y')
title('traj')
xlim([0 10])
ylim([0 10])
legend('qd','q','qKF','Location','southeast')

%plot orientation across time

figure(2)
plot(tlist,qdlist(3,:),tlist,qlist(3,:),tlist,qhatKFlist(3,:))
grid on
xlabel('t')
ylabel('thetatr')
title('trajtheta')
legend('thetad','theta','thetaKF','Location','southwest')
...
title('lande')
if nb+nr ==4
legend('eL_1','eL_2','eL_3','eB_1','Location','northeast')
elseif nb+nr == 6
legend('eL_1','eL_2','eL_3','eL_4','eB_1','eB_2','Location','northeast')
else
legend('eL_1','eL_2','eL_3','eL_4','eL_5','eB_1','eB_2','eB_3','Location','northeast')
end
